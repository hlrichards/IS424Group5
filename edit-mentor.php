...
<body class="bg">
    ...
    <div class="has-text-centered has-background-aqua">
        <form action="edit-mentor.php" method="post" style="padding-top:50px;color: black; width:50%; margin-left:25%; margin-right:25%" role="form">
            <label><b>You must enter an ID for the entry you are editing, deleting, or adding</b></label>
          <div class="form-group">
            <label>Mentor ID</label>
            <input type="text" name="mentor_id" class="form-control" maxlength="10" required>
          </div>
          <div class="form-group">
            <label>Mentor Name</label>
            <input type="text" name="mentor_name" class="form-control" maxlength="200">
          </div>
            <p>
...
if (isset($_POST['submit1'])){
	...
	$query="";
	if (!($name == "")) {
	    $query = "UPDATE mentor SET mentor_name='$name' WHERE mentor_id='$id'";
	}
	if($query != "") {
	    $result = mysqli_query($conn, $query);
	}
	echo "<META HTTP-EQUIV=\"refresh\" content=\"0; URL=mentor.php\"> ";
}
...
if (isset($_POST['submit3'])){
	...
	$query = "INSERT INTO mentor (mentor_id, mentor_name) VALUES ('$id','$name')";
    $result = mysqli_query($conn, $query);
    echo "<META HTTP-EQUIV=\"refresh\" content=\"0; URL=mentor.php\"> ";
}
